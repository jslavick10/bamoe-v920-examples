...
1. Run `mvn clean package -Dcontainer` to build the project and generate dashboards.  A docker image tagged `com.ibm.bamoe/dmn-drools-springboot-metrics-example:1.0` will be built (docker must be installed on your system).
