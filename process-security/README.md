...
```
PROJECT_VERSION=9.2.0-ibm-0004
MANAGEMENT_CONSOLE_IMAGE=quay.io/bamoe/management-console:9.2.0-ibm-0004
COMPOSE_PROFILES=container
HOST=127.0.0.1
```

- `PROJECT_VERSION`: Should be set with the current version being used: `PROJECT_VERSION=9.2.0-ibm-0004`
- `MANAGEMENT_CONSOLE_IMAGE`: Should be set with the Kogito Management Console image `quay.io/bamoe/management-console:9.2.0-ibm-0004`
